<template>
    <div class="cl-upload-space__wrap">
        <slot>
            <el-button v-if="showButton" size="mini" @click="open">{{ bottomTxt }}</el-button>
        </slot>
        ...
        >
            <div class="cl-upload-space">
                ...
                <div class="cl-upload-space__content">
                    ...
                    <div class="cl-upload-space__header scroller1">
                        ...
                        <el-button type="success" size="mini" :disabled="!isSelected" @click="confirm()">使用选中文件 {{ limitTip }}</el-button>

                        <el-button type="danger" size="mini" :disabled="!isSelected" @click="remove()">删除选中文件</el-button>
                    </div>

                    <!-- 文件区域 -->
                    <div v-loading="loading" class="cl-upload-space__file scroller1" element-loading-text="拼命加载中">
                        <!-- 文件列表 -->
            ...
            <template #slot-expand>
                <button>
                    <i v-if="category.visible" class="el-icon-notebook-2" @click="category.visible = false"></i>
