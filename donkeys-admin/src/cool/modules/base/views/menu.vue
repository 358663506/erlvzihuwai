        ...
        <el-row>
            <cl-table :ref="setRefs('table')" v-bind="table" @row-click="onRowClick">
                ...
                <template #column-name="{ scope }">
                    ...
                    <el-tag v-if="!scope.row.isShow" size="mini" effect="dark" type="danger" style="margin-left: 10px">隐藏</el-tag>
                </template>
                ...
                <template #column-router="{ scope }">
                    <el-link v-if="scope.row.type == 1" type="primary" :href="scope.row.router">{{ scope.row.router }}</el-link>
                ...
                <template #slot-add="{ scope }">
                    <el-button v-if="scope.row.type != 2" type="text" size="mini" @click="upsertAppend(scope.row)">新增</el-button>
                </template>
            </cl-table>
        </el-row>
