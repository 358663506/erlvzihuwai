...
__webpack_require__.d(__webpack_exports__, "emitter", function() { return /* reexport */ src_emitter; });
__webpack_require__.d(__webpack_exports__, "crudList", function() { return /* reexport */ crudList; });
...
__webpack_require__.d(__webpack_exports__, "useTools", function() { return /* reexport */ useTools; });
__webpack_require__.d(__webpack_exports__, "useCore", function() { return /* reexport */ useCore; });
      ...
      if (name == _name) {
        e.callback(data, {
          ...
          refresh: function refresh(params) {
            crudList.forEach(function (c) {
              return c.refresh(params);
            });
          }
        });
      }
...
var app_bootstrap = function bootstrap(crud) {
  ...
  ctx.on = function (name, callback) {
    src_emitter.on("".concat(name, "-").concat(ctx.id), callback);
  };
...
/* harmony default export */ var dist_mitt = (function(n){return{all:n=n||new Map,on:function(t,e){var i=n.get(t);i?i.push(e):n.set(t,[e])},off:function(t,e){var i=n.get(t);i&&(e?i.splice(i.indexOf(e)>>>0,1):n.set(t,[]))},emit:function(t,e){var i=n.get(t);i&&i.slice().map(function(n){n(e)}),(i=n.get("*"))&&i.slice().map(function(n){n(t,e)})}}});
...
var mitt_Emitter = /*#__PURE__*/function () {
  ...
  _createClass(Emitter, [{
    ...
    value: function send(type, name) {
      ...
      mitt_emitter[type].apply(mitt_emitter, ["".concat(this.id, "__").concat(name)].concat(args));
    }
  }, {
    key: "on",
...
/* harmony default export */ var components_crud = (Object(external_commonjs_vue_commonjs2_vue_root_Vue_["defineComponent"])({
  ...
  setup: function setup(props, _ref) {
    ...
    var crud = Object(external_commonjs_vue_commonjs2_vue_root_Vue_["reactive"])({
      id: props.name || (ctx === null || ctx === void 0 ? void 0 : ctx.uid),
    ...
    Object(lib_src["merge"])(crud, useMitt({
      mitt: mitt
    }), useRequest({
      mitt: mitt,
      props: props,
    ...
    Object(external_commonjs_vue_commonjs2_vue_root_Vue_["provide"])("mitt", mitt); // 加载
...
function parseNode(vnode, options) {
  ...
  var props = _objectSpread2(_objectSpread2(_objectSpread2(_objectSpread2(_objectSpread2({}, vnode.attrs), vnode.props), options._data), vnode), {}, {
    scope: scope
  }); // 添加双向绑定
...
function renderNode(vnode, _ref2) {
  ...
  if (isObject(vnode)) {
    if (vnode.name) {
      // 扩展组件
      var elms = ["el-select", "el-radio-group", "el-checkbox-group"];
...
/* harmony default export */ var adv_search = (Object(external_commonjs_vue_commonjs2_vue_root_Vue_["defineComponent"])({
  ...
  setup: function setup(props, _ref) {
    ...
    var _useForm = useForm(props),
        setFormData = _useForm.setFormData; // 表单数据
...
var format = {
  ...
  datetimeRange: function datetimeRange(value, _ref) {
    var form = _ref.form,
        method = _ref.method,
        prop = _ref.prop;
    var key = prop.charAt(0).toUpperCase() + prop.slice(1);
    var start = "start".concat(key);
    var end = "end".concat(key);
  ...
  splitJoin: function splitJoin(value, _ref4) {
...
function form_parse(method, _ref5) {
...
/* harmony default export */ var hooks_form = ({
  bind: function bind(data) {
    return form_parse("bind", data);
  },
  submit: function submit(data) {
    return form_parse("submit", data);
  }
});
...
/* harmony default export */ var components_form = (Object(external_commonjs_vue_commonjs2_vue_root_Vue_["defineComponent"])({
  ...
  setup: function setup(props, _ref) {
    ...
    var _useTools = useTools(),
        browser = _useTools.browser; // 设置表单值
                ...
                case 0:
                  if (valid) {
                    ...
                    conf.items.forEach(function (e) {
                      ...
                      if (e.hook) {
                        d[e.prop] = hooks_form.submit(_objectSpread2(_objectSpread2({}, e), {}, {
                          value: d[e.prop],
                          form: d
                        }));
                      }
    ...
    function open(options) {
      ...
      conf.items.map(function (e) {
        if (e.prop) {
          ...
          form[e.prop] = hooks_form.bind(_objectSpread2(_objectSpread2({}, e), {}, {
          ...
          if (e.required) {
            e.rules = {
              required: true,
              message: "".concat(e._label.text, "\u4E0D\u80FD\u4E3A\u7A7A")
            };
          }
        } // 设置 tabs 默认值
    ...
    function reBindForm(data) {
      var d = {};
      conf.items.forEach(function (e) {
        d[e.prop] = e.hook ? hooks_form.bind(_objectSpread2(_objectSpread2({}, e), {}, {
          value: data[e.prop],
          form: data
        })) : data[e.prop];
      });
          ...
          default: function _default() {
            return [e.component && Object(external_commonjs_vue_commonjs2_vue_root_Vue_["h"])(Object(external_commonjs_vue_commonjs2_vue_root_Vue_["withDirectives"])(Object(external_commonjs_vue_commonjs2_vue_root_Vue_["createVNode"])(Object(external_commonjs_vue_commonjs2_vue_root_Vue_["resolveComponent"])("el-form-item"), null, null), [[external_commonjs_vue_commonjs2_vue_root_Vue_["vShow"], e._group]]), _objectSpread2({
              ...
              label: function label() {
                var _e$_label, _e$_label2, _e$_label3, _e$_label4, _e$_label5;
                ...
                return Object(external_commonjs_vue_commonjs2_vue_root_Vue_["createVNode"])(Object(external_commonjs_vue_commonjs2_vue_root_Vue_["resolveComponent"])("el-tooltip"), {
                  "effect": "dark",
                  "placement": "top",
                  "content": (_e$_label = e._label) === null || _e$_label === void 0 ? void 0 : _e$_label.tip,
                  "disabled": !((_e$_label2 = e._label) !== null && _e$_label2 !== void 0 && _e$_label2.tip)
                }, {
                  default: function _default() {
                    return [Object(external_commonjs_vue_commonjs2_vue_root_Vue_["createVNode"])("span", null, [(_e$_label3 = e._label) === null || _e$_label3 === void 0 ? void 0 : _e$_label3.text, ((_e$_label4 = e._label) === null || _e$_label4 === void 0 ? void 0 : _e$_label4.icon) && Object(external_commonjs_vue_commonjs2_vue_root_Vue_["createVNode"])("i", {
                      "class": (_e$_label5 = e._label) === null || _e$_label5 === void 0 ? void 0 : _e$_label5.icon
                    }, null)])];
                  }
                });
              },
...
/* harmony default export */ var search_key = (Object(external_commonjs_vue_commonjs2_vue_root_Vue_["defineComponent"])({
  ...
  setup: function setup(props, _ref) {
    ...
    var _useCore = useCore(),
        crud = _useCore.crud; // 选中字段


    var selectField = Object(external_commonjs_vue_commonjs2_vue_root_Vue_["ref"])(props.field); // 文字提示

    var placeholder2 = Object(external_commonjs_vue_commonjs2_vue_root_Vue_["computed"])(function () {
    ...
    var value = Object(external_commonjs_vue_commonjs2_vue_root_Vue_["ref"])(null);
    Object(external_commonjs_vue_commonjs2_vue_root_Vue_["watch"])(function () {
      return props.modelValue;
    }, function (val) {
      value.value = val;
    ...
    function search() {
      ...
      function next(newParams) {
        crud.refresh(_objectSpread2(_objectSpread2({
          page: 1
        }, params), {}, _defineProperty({}, selectField.value, value.value || null), newParams));
      }
...
/* harmony default export */ var table = (Object(external_commonjs_vue_commonjs2_vue_root_Vue_["defineComponent"])({
  ...
  setup: function setup(props, _ref) {
    ...
    var _useCore = useCore(),
        crud = _useCore.crud,
        mitt = _useCore.mitt; // el-table api
    ...
    function onRowContextMenu(row, column, event) {
      ...
      if (enable) {
        // 高亮
        refs.value.table.setCurrentRow(row); // 解析按钮
    ...
    function calcMaxHeight() {
      ...
      Object(external_commonjs_vue_commonjs2_vue_root_Vue_["nextTick"])(function () {
        ...
        if (vm) {
          ...
          maxHeight.value = crud.crudRef.clientHeight - _h;
        }
      });
    } // 显示列
    ...
    var defaultSort = props.props["default-sort"] || props.props.defaultSort || {};

    function useSort() {
      var _ref3 = defaultSort || {},
          prop = _ref3.prop,
          order = _ref3.order;

      var item = props.columns.find(function (e) {
        return ["desc", "asc", "descending", "ascending"].includes(e.sortable);
      });
    ...
    mitt.on("crud.refresh", function (_ref4) {
      var list = _ref4.list;
      data.value = list;
    }); // 窗口大小改变事件
  ...
  render: function render(ctx) {
    var _useCore2 = useCore(),
        crud = _useCore2.crud; // 渲染列
...
/* harmony default export */ var components_dialog = (Object(external_commonjs_vue_commonjs2_vue_root_Vue_["defineComponent"])({
  ...
  setup: function setup(props, _ref) {
    ...
    var _useTools = useTools(),
        browser = _useTools.browser; // 是否全屏
...
/* harmony default export */ var filter_group = (Object(external_commonjs_vue_commonjs2_vue_root_Vue_["defineComponent"])({
  ...
  setup: function setup(props, _ref) {
    ...
    var _useCore = useCore(),
        crudConf = _useCore.crudConf,
        crud = _useCore.crud;

    var _useForm = useForm(props),
        setFormData = _useForm.setFormData; // 旧数据


    var oldForm = clone_deep_default()(props.modelValue); // 表单数据

    var form = setFormData(); // 加载中
...
var CRUD = {
  install: function install(app, options) {
    var _ref = options || {},
        _ref$crud = _ref.crud,
        crud = _ref$crud === void 0 ? {} : _ref$crud,
        events = _ref.events; // 事件


    if (events) {
      src_emitter.init(events);
    } // 样式
