...
class BaseEsIndex {
    ...
    async find(body, size) {
        ...
        return this.client
            ...
            .then((res) => {
            return (res.body.hits.hits.map((e) => {
                e._source.id = e._id;
                return e._source;
            }) || []);
        });
    ...
    async findPage(body, page, size) {
        ...
        return this.client.search({ index: this.index, body }).then((res) => {
            const result = res.body.hits.hits.map((e) => {
                e._source.id = e._id;
                return e._source;
            }) || [];
            return {
    ...
    async findById(id) {
        return this.client
            ...
            .then((res) => {
            res.body._source.id = res.body._id;
            return res.body._source || undefined;
        })
            .catch((e) => {
            return undefined;
        });
    ...
    async findByIds(ids) {
        return this.client
            ...
            .then((res) => {
            const result = res.body.docs.map((e) => {
                e._source.id = e._id;
