...
class CryptoKit {
    constructor(config, msgSignature, timestamp, nonce) {
    ...
    KCS7Encoder(textLength) {
        ...
        // 获得补位所用的字符
        let pad = String.fromCharCode(amountToPad), s = [];
...
exports.CryptoKit = CryptoKit;
//用于构建 xml 结构
CryptoKit.xmlParser = new xml2js.Builder({
    rootName: 'xml',
    cdata: true,
    headless: true,
    renderOpts: {
...
//# sourceMappingURL=CryptoKit.js.map