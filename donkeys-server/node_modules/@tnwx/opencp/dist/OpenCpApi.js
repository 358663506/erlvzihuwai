...
class OpenCpApi {
     ...
     */
    static setSessionInfo(preAuthCode, authType = 0, appId) {
        return __awaiter(this, void 0, void 0, function* () {
            let accessToken = yield accesstoken_1.OpenCpAccessTokenApi.getAccessToken(accesstoken_1.AccessTokenType.SUITE_TOKEN);
     ...
     */
    static getPermanentCode(authCode) {
        return __awaiter(this, void 0, void 0, function* () {
            let accessToken = yield accesstoken_1.OpenCpAccessTokenApi.getAccessToken(accesstoken_1.AccessTokenType.SUITE_TOKEN);
     ...
     */
    static getAuthInfo(authCorpId, permanentCode) {
        return __awaiter(this, void 0, void 0, function* () {
            let accessToken = yield accesstoken_1.OpenCpAccessTokenApi.getAccessToken(accesstoken_1.AccessTokenType.SUITE_TOKEN);
     ...
     */
    static getAdminList(authCorpId, agentId) {
        return __awaiter(this, void 0, void 0, function* () {
            let accessToken = yield accesstoken_1.OpenCpAccessTokenApi.getAccessToken(accesstoken_1.AccessTokenType.SUITE_TOKEN);
     ...
     */
    static searchContact(authCorpId, queryWord, queryType, agentId, offset, limit) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     * @param agentId 应用id
     */
    static batchSearchContact(authCorpId, queryRequestList, agentId) {
        return __awaiter(this, void 0, void 0, function* () {
            let accessToken = yield accesstoken_1.OpenCpAccessTokenApi.getAccessToken(accesstoken_1.AccessTokenType.PROVIDER_TOKEN);
     ...
     */
    static upload(mediaType, filePath) {
        return __awaiter(this, void 0, void 0, function* () {
            let accessToken = yield accesstoken_1.OpenCpAccessTokenApi.getAccessToken();
     ...
     */
    static contactIdTranslate(authCorpId, mediaIdList, outputFileName) {
        return __awaiter(this, void 0, void 0, function* () {
            let accessToken = yield accesstoken_1.OpenCpAccessTokenApi.getAccessToken(accesstoken_1.AccessTokenType.PROVIDER_TOKEN);
     ...
     */
    static sortContact(authCorpId, userIdList, sortType) {
        return __awaiter(this, void 0, void 0, function* () {
            let accessToken = yield accesstoken_1.OpenCpAccessTokenApi.getAccessToken(accesstoken_1.AccessTokenType.PROVIDER_TOKEN);
