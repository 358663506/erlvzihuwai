...
class ShakeAroundPageApi {
     ...
     * @param accessToken
     */
    static addPage(title, description, pageUrl, iconUrl, comment, accessToken) {
     ...
     * @param accessToken
     */
    static updatePage(pageId, title, description, pageUrl, iconUrl, comment, accessToken) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!accessToken) {
                accessToken = yield accesstoken_1.AccessTokenApi.getAccessToken();
            }
     ...
     * @param accessToken
     */
    static searchPageByIds(pageIds, accessToken) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!accessToken) {
                accessToken = yield accesstoken_1.AccessTokenApi.getAccessToken();
            }
     ...
     * @param accessToken
     */
    static searchPage(begin, count, accessToken) {
        return __awaiter(this, void 0, void 0, function* () {
            if (begin < 0)
                begin = 0;
            if (count < 1)
     ...
     * @param accessToken
     */
    static deletePage(pageId, accessToken) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!accessToken) {
                accessToken = yield accesstoken_1.AccessTokenApi.getAccessToken();
            }
...
exports.ShakeAroundPageApi = ShakeAroundPageApi;
ShakeAroundPageApi.addPageUrl = 'https://api.weixin.qq.com/shakearound/page/add?access_token=%s';
ShakeAroundPageApi.updatePageUrl = 'https://api.weixin.qq.com/shakearound/page/update?access_token=%s';
ShakeAroundPageApi.searchPageUrl = 'https://api.weixin.qq.com/shakearound/page/search?access_token=%s';
ShakeAroundPageApi.deletePageUrl = 'https://api.weixin.qq.com/shakearound/page/delete?access_token=%s';
//# sourceMappingURL=ShakeAroundPageApi.js.map